...
- Add OCR fallback path (when text layer quality is poor) and reliability-based filtering.
...
- Add per-record quality indicators (low/medium/high reliability).
- Done when downstream analyses can optionally filter low-reliability records.
